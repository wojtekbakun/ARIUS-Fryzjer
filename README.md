...
| POST   | `/payments`             | Body: `{ "user_id": "int", "amount": "float" }`                                                            | `{ "message": "Payment created" }`            |
| GET    | `/invoice-data`         | Nagłówek: `Authorization: Bearer <token>`                                                                  | `{ "id": "int", "email": "string", "street": "string", "street_number": "string", "postal_code": "string", "city": "string", "nip": "string", "company_name": "string", "purchase_date": "YYYY-MM-DD" }` |
| POST   | `/invoice-data`         | Nagłówek: `Authorization: Bearer <token>`, Body: `{ "street": "string", "street_number": "string", "postal_code": "string", "city": "string", "nip": "string", "company_name": "string" }` | `{ "message": "Invoice data updated successfully" }` |
